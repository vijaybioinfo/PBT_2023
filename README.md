...
We also did scRNA-seq and scTCR-seq of NSCLC patients (n=10), a tumor type with high TMB where ICBs have shown promising outcomes, to compare features of clonally expanded cells and evaluate their similarity in terms of the diversity of the TCR repertoir.
