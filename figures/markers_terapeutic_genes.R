...
{ cat(redb("### Target genes heatmap Expanded cells - CD4 & CD8 ### %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n"))
  ...
  setwd('/home/kmlanderos/tmp_large/pbtumor-all-Batch2/results/figures')

  sc_cd3p_cd4 <- readRDS("data/sc_cd3p_cd4_Batch1_Batch2_seurat_object_subset.rds")
  sc_cd3p_cd8 <- readRDS("data/sc_cd3p_cd8_Batch1_Batch2_seurat_object_subset.rds")
  ...
  result_id = "immune_targets/"; dir.create("immune_targets")
  fconfigs = list(
  ...
  for (fconfig in fconfigs) {
    ...
    donors <- c("BT1", "BT2", "BT3", "BT4", "BT5", "BT7", "BT8", "BT9", "BT10", "BT11", "BT12", "BT13", "BT15", "BT17_brain", "BT18", "BT19", "BT20", "BT21", "BT22", "BT23", "BT24", "BT25", "BT26", "BT27", "BT29", "BT30", "BT31", "BT32", "BT35", "BT37", "BT38", "BT39", "BT40", "BT43", "BT44", "BT45", "BT46", "BT47", "BT48")
    grade <- c("LG","HG","LG","LG","LG","LG","LG","LG","HG","HG","HG","HG","HG","HG","HG","LG","HG","HG","HG","HG","LG","LG","HG","LG","HG", "HG", "HG", "LG", "LG", "HG", "HG", "HG", "HG", "HG", "LG", "HG", "HG", "HG", "HG")

    if(fconfig$object == "sc_cd3p_cd4") {
      donors2exclude <- c("BT10", "BT29", "BT30", "BT31", "BT35", "BT37", "BT38", "BT39", "BT44", "BT45", "BT47", "BT48")
      grade <- grade[which(!donors %in% donors2exclude)]
      donors <- donors[which(!donors %in% donors2exclude)]
    }
